        ...
        <div>
            ...
            <div class="table-block">
                <table class="table-tabledata" id="table-data">
                    ...
                    <tr>
                        <td rowspan="5">{{ Session::get('m_before') }}/{{ Session::get('y_before') }}</td>
                    </tr>
                    <tr>
                        <td>รวม DC 1</td>
                        <td>
            ...
            <table class="table-print table-print1Cus">
                ...
                <tr>
                    <td rowspan="4">{{ Session::get('m_before') }}/{{ Session::get('y_before') }}</td>
                    <td>รวม DC1</td>
                    <td>
            ...
            <table class="table-print table-print4Cus">
                <tr>
                    <td colspan="16">โอนออก</td>
                    <td colspan="8">ส่งขาย</td>
                </tr>
