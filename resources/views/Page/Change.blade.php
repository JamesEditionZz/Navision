                ...
                <div class="table-block">
                    <table class="table-edit">
                        ...
                        <tr>
                            ...
                            <td id="Customer" class="dblclickable" data-itemno="{{ $row->ItemNo }}"
                                data-Customer="{{ $row->Customer }}">
                                <span>{{ $row->Customer }}</span>
                                <div>
                                    <input type="text" class="edit-inputCus edit-input" value="{{ $row->Customer }}"
                                        style="display: none;" id="InputCustomer">
                                </div>
                            </td>
                            <td id="PriceAvg" class="dblclickable" data-itemno="{{ $row->ItemNo }}"
                                data-PriceAvg="{{ $row->PriceAvg }}">
                                <span>{{ $row->PriceAvg }}</span>
                                <div>
                                    <input type="text" class="edit-inputAvg edit-input" value="{{ $row->PriceAvg }}"
                                        style="display: none;" id="InputPriceAvg">
                                </div>
                            </td>
                            <td id="PcsAfter" class="dblclickable" data-itemno="{{ $row->ItemNo }}"
                                data-PcsAfter="{{ $row->PcsAfter }}">
                                <span>{{ $row->PcsAfter }}</span>
                                <div>
                                    <input type="text" class="edit-inputPcs edit-input" value="{{ $row->PcsAfter }}"
                                        style="display: none;" id="InputPcsAfter">
                                </div>
                            </td>
                            <td id="PriceAfter" class="dblclickable" data-itemno="{{ $row->ItemNo }}"
                                data-PriceAfter="{{ $row->PriceAfter }}">
                                <span>{{ $row->PriceAfter }}</span>
                                <div>
                                    <input type="text" class="edit-inputPrice edit-input" value="{{ $row->PriceAfter }}"
                                        style="display: none;" id="InputPriceAfter">
                                </div>
                            </td>
                            <td id="Category" class="dblclickable" data-itemno="{{ $row->ItemNo }}"
                                data-Category="{{ $row->Category }}">
                                <span>{{ $row->Category }}</span>
                                <div>
                                    <input type="text" class="edit-inputCate edit-input" value="{{ $row->Category }}"
                                        style="display: none;" id="InputCategory">
                                </div>
                            </td>
                        </tr>
                        @endforeach
...
$(document).ready(function() {
    $('.dblclickable').dblclick(function() {
        ...
        var inputAvg = $(this).find('.edit-inputAvg');
        inputAvg.show().focus();
        ...
        inputAvg.on('blur', function() {
            var fixAvg = $(this).val();
            inputAvg.hide()

            $(this).parent('div').siblings('span').text(fixAvg).show();
