...
class BackDataController extends Controller
{
    public function backdata(Request $request)
    {
        ...
        $log_price = DB::table('log_price')->where('DataUpdate_Old', $date)->count();
        $item_all = DB::table('item_all_old')->where('DataUpdate_Old', $date)->count();
        $po = DB::table('po_old')->where('DataUpdate_Old', $date)->count();
        $neg = DB::table('neg_old')->where('DataUpdate_Old', $date)->count();
        $purchase = DB::table('purchase_old')->where('DataUpdate_Old', $date)->count();
        $returncuses = DB::table('returncuses_old')->where('DataUpdate_Old', $date)->count();
        $a71__f1_fg_bu02s = DB::table('a71__f1_fg_bu02s_old')->where('DataUpdate_Old', $date)->count();
        $a72__f2_fg_bu10s = DB::table('a72__f2_fg_bu10s_old')->where('DataUpdate_Old', $date)->count();
        $a73__f2_th_bu05s = DB::table('a73__f2_th_bu05s_old')->where('DataUpdate_Old', $date)->count();
        $a74__f2_de_bu10s = DB::table('a74__f2_de_bu10s_old')->where('DataUpdate_Old', $date)->count();
        $a75__f2_ex_bu11s = DB::table('a75__f2_ex_bu11s_old')->where('DataUpdate_Old', $date)->count();
        $a76__f2_tw_bu04s = DB::table('a76__f2_tw_bu04s_old')->where('DataUpdate_Old', $date)->count();
        $a77__f2_tw_bu07s = DB::table('a77__f2_tw_bu07s_old')->where('DataUpdate_Old', $date)->count();
        $a78__f2_ce_bu10s = DB::table('a78__f2_ce_bu10s_old')->where('DataUpdate_Old', $date)->count();
        $returnitem = DB::table('คืนของs_old')->where('DataUpdate_Old', $date)->count();
        $a81__f1_fg_bu02s = DB::table('a81__f1_fg_bu02s_old')->where('DataUpdate_Old', $date)->count();
        $a82__f2_fg_bu10s = DB::table('a82__f2_fg_bu10s_old')->where('DataUpdate_Old', $date)->count();
        $a83__f2_th_bu05s = DB::table('a83__f2_th_bu05s_old')->where('DataUpdate_Old', $date)->count();
        $a84__f2_de_bu10s = DB::table('a84__f2_de_bu10s_old')->where('DataUpdate_Old', $date)->count();
        $a85__f2_ex_bu11s = DB::table('a85__f2_ex_bu11s_old')->where('DataUpdate_Old', $date)->count();
        $a86__f2_tw_bu04s = DB::table('a86__f2_tw_bu04s_old')->where('DataUpdate_Old', $date)->count();
        $a87__f2_tw_bu07s = DB::table('a87__f2_tw_bu07s_old')->where('DataUpdate_Old', $date)->count();
        $a88__f2_ce_bu10s = DB::table('a88__f2_ce_bu10s_old')->where('DataUpdate_Old', $date)->count();
        $dc1_s = DB::table('dc1_s_old')->where('DataUpdate_Old', $date)->count();
        $dcp_s = DB::table('dcp_s_old')->where('DataUpdate_Old', $date)->count();
        $dcy_s = DB::table('dcy_s_old')->where('DataUpdate_Old', $date)->count();
        $dex_s = DB::table('dex_s_old')->where('DataUpdate_Old', $date)->count();
        $item_stock = DB::table('item_stock_old')->where('DataUpdate_Old', $date)->count();
