...
return new class extends Migration
{
    ...
    {
        Schema::create('คืนของs', function (Blueprint $table) {
            ...
            $table->double('Purchase Amount (Actual)', 10, 2)->nullable(true);
        });
